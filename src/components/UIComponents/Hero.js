  ...
  return (
    <Row>
      <Col md={10}>
        <Row>
          <Col xs={24}>
            <Typography.H className="font-26 text-700">{title}</Typography.H>
          </Col>
          <Col xs={24}>
          ...
          <Col xs={18}>
            <Typography.P className="font-16 mb-5 color-black text-400" >Build a web or mobile integration to accept payments online or in person</Typography.P>
          </Col>
          <Col xs={24}>
